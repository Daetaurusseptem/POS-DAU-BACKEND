...
const getMenuFrontEnd = (role = 'admin') => {
    ...
    if (role === 'admin') {
        ...
        { title: 'Usuarios', url: 'admin/users', icon: 'bi bi-people-fill' }, { title: 'Productos', url: 'admin/products', icon: 'bi bi-bag-fill' }, { title: 'Proveedores', url: 'admin/suppliers', icon: 'bi bi-file-earmark-person' }, { title: 'Inventario', url: 'admin/items', icon: 'bi bi-box2-fill' }, { title: 'Categorias', url: 'admin/categories', icon: 'bi bi-bookmark-fill' }, { title: 'recetas', url: 'admin/recipes', icon: 'bi bi-backpack4' }, { title: 'ingredientes', url: 'admin/ingredients-list', icon: 'bi bi-egg-fill' });
    }
    if (role === 'user') {
